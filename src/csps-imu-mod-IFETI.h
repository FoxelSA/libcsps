 ...
 */
    ...
    # ifndef __LP_IMU_IFETI___
    # define __LP_IMU_IFETI___
 ...
 */
    ...
    # define LP_IMU_IFETI__DEV "imu"
    # define LP_IMU_IFETI__MOD "mod-IFETI"
    # define LP_IMU_IFETI__DES "Inertial Frame Explicit Time Integration"
