 ...
 */
    ...
    lp_IMU lp_imu_mod_IOISA(
        ...
        /* Obtain stream size */
        lpSize = lp_stream_size( lpPath, LP_IMU_MODIOISA_DEV, lpDevice.dvTag, lpPS__, "syn" ) / sizeof( lp_Time_t );

        /* Read streams data */
        lpDEVacx = lp_stream_read( lpPath, LP_IMU_MODIOISA_DEV, lpDevice.dvTag, lpPS__, "acx", sizeof( lp_Real_t ) * lpSize );
        lpDEVacy = lp_stream_read( lpPath, LP_IMU_MODIOISA_DEV, lpDevice.dvTag, lpPS__, "acy", sizeof( lp_Real_t ) * lpSize );
        lpDEVacz = lp_stream_read( lpPath, LP_IMU_MODIOISA_DEV, lpDevice.dvTag, lpPS__, "acz", sizeof( lp_Real_t ) * lpSize );
        lpDEVgrx = lp_stream_read( lpPath, LP_IMU_MODIOISA_DEV, lpDevice.dvTag, lpPS__, "grx", sizeof( lp_Real_t ) * lpSize );
        lpDEVgry = lp_stream_read( lpPath, LP_IMU_MODIOISA_DEV, lpDevice.dvTag, lpPS__, "gry", sizeof( lp_Real_t ) * lpSize );
        lpDEVgrz = lp_stream_read( lpPath, LP_IMU_MODIOISA_DEV, lpDevice.dvTag, lpPS__, "grz", sizeof( lp_Real_t ) * lpSize );
        lpDEVsyn = lp_stream_read( lpPath, LP_IMU_MODIOISA_DEV, lpDevice.dvTag, lpPS__, "syn", sizeof( lp_Time_t ) * lpSize );
