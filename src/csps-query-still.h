 ...
 */
     ...
     *
     *  This function is a front-end to lp_query_still_create function that
     *  takes advantage of the origin directive introduced in topology. It 
     *  retrieves the module and device name and tag declared as still-range
     *  origin in the topology in order to call lp_query_still_create. It then
     *  returns the created query structure on still-range.
     *
