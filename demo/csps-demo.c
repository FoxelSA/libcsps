        ...
        while ( ( cspsGetOpt = getopt( argc, argv, "p:h" ) ) != -1 ) {
            ...
            switch ( cspsGetOpt ) {
                ...
                case 'p' : {
                    ...
                    /* CSPS display message */
                    printf( "Processing CSPS on structure\n    %s\n", optarg );

                    /* CSPS full processing testing */
                    csps_system( optarg );
                    ...
                    printf( "Timerange of the processed structure (IMU based/Device timezone)\n    From %" PRIu64 ".%5" PRIu64 " [s]\n    To   %" PRIu64 ".%5" PRIu64 " [s]\n" ,

                        csps_timestamp_sec ( cspsTime.qrInitial ),
                        csps_timestamp_usec( cspsTime.qrInitial ),
                        csps_timestamp_sec ( cspsTime.qrFinal   ),
                        csps_timestamp_usec( cspsTime.qrFinal   )
